...
Webflow.require('ix').init([
  {"slug":"fade-in-and-move-up","name":"Fade in and move up","value":{"style":{"opacity":0.25,"x":"0px","y":"100px"},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"transition":"transform 500ms ease-in-out-sine 0ms, opacity 500ms ease-in-out-sine 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"zoom-in-and-fade-in","name":"Zoom in and fade in","value":{"style":{"opacity":0.25,"scale":0.8},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"transition":"transform 500ms ease-in-out-sine 0ms, opacity 500ms ease-in-out-sine 0ms","scale":1}],"stepsB":[]}]}}
]);
